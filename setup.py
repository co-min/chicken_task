...
def find_python310():
    """Windows py launcher에서 Python 3.10 찾기"""
    try:
    ...
    print("\n[ERROR] Python 3.10이 설치되어 있지 않습니다.")
    print("👉 Python 3.10 설치 후 다시 실행하세요.")
    exit(1)
...
def create_venv():
    ...
    print("[INFO] Python 3.10로 가상환경 생성 중...")
    run(py310 + ["-m", "venv", str(VENV_DIR)])
